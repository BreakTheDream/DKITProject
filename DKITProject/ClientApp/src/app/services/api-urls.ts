export const API_URLS = {
    AUTH_URL: '/api/authorization',
    CHECK_ACCESS_URL: '/api/checkaccess',
    POST_SPECIALITY_URL: '/api/administration/postspeciality',
    PUT_SPECIALITY_URL: '/api/administration/putspeciality',
